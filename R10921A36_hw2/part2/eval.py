...
def main():
    ...
    num_out = 10    
    if args.model == 'mylenet':
        path = './save_dir/myLeNet/best_model.pt'
        model = myLeNet(num_out=num_out)
    elif args.model == 'myresnet':
        path = './save_dir/myResnet/best_model.pt'
        model = myResnet()
    elif args.model == 'pretrained_resnet50':
        path = './save_dir/pretrained_resnet50/best_model.pt'
